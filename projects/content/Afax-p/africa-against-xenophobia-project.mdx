...
Not more than **250 words** abstract should be sent to [info@imilinstitute.org](mailto:info@imilinstitute.org?subject=GJMIL) by **August 15, 2026**. Please use the email subject: **GJMIL**.
