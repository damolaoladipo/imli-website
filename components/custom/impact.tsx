        ...
        <section className="bg-[#FBAF4B] @container py-12 sm:py-16 md:py-24 lg:py-40 px-4 md:px-0">
            <div className="mx-auto max-w-4xl px-4 sm:px-6">
                <div className="space-y-3 sm:space-y-4">
                    ...
                    <p className="max-w-2xl text-pretty text-lg text-neutral-900 sm:text-xl">{siteConfig.tagline} {siteConfig.fullName} supports countries in monitoring progress, generating research, strengthening public–private partnerships, and advancing media and information literacy policies.</p>
                </div>
                <div className="mt-8 grid grid-cols-1 gap-0 divide-y divide-neutral-900/25 sm:mt-12 @xl:mt-12 @xl:grid @xl:grid-cols-3 @xl:gap-0 @xl:divide-y-0 @xl:divide-x @xl:divide-neutral-900/25">
                    <div className="py-5 first:pt-0 @xl:first:pt-6 @xl:py-6 @xl:pr-6 @xl:first:pl-0">
                        <p className="max-w-xl text-pretty text-lg text-neutral-900 sm:text-xl">
