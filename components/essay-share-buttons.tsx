...
interface EssayShareButtonsProps {
  title: string;
  url: string;
}

export function EssayShareButtons({ title, url }: EssayShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2 pt-2">
      ...
      >
        {copied ? (
          <span className="text-[10px] font-medium text-foreground">Copied</span>
        ) : (
